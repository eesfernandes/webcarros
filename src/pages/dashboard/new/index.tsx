...
export function New(){
    ...
    async function handleDeteleImage(item: ImageItemProps){
    ...
    return(
        <Container>
            ...
            <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2">
                ...
                {carImages.map( item => (
                    <div key={item.name} className="w-full h-32 flex items-center justify-center relative">
                        <button className="absolute" onClick={() => handleDeteleImage(item)}>
            ...
            <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2 my-2">
                <form
                    className="w-full"
